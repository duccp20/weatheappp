...
def change_image():
    ...
    if data[0]['weather'][0]['main'] == "Rain":
        bg.config(width=900, height=500, bg="#87CEEB")
        bottom_box.config(bg="#87CEEB")
        search_box.config(bg="#87CEEB")
        name.config(bg="#87CEEB")
        clock.config(bg="#87CEEB")
        date.config(bg="#87CEEB")
        search_icon.config(bg="#29393f")
        textfield.config(bg="#29393f")
        label1.config(bg="#0eb1ee")
        label2.config(bg="#0eb1ee")
        label3.config(bg="#0eb1ee")
        label4.config(bg="#0eb1ee")
        w.config(bg="#0eb1ee")
        h.config(bg="#0eb1ee")
        p.config(bg="#0eb1ee")
        d.config(bg="#0eb1ee")
        logo.config(bg="#87CEEB", image=rain)
        logo.image = rain
    elif data[0]['weather'][0]['main'] == "Clouds":
        bg.config(width=900, height=500, bg="#B0E0E6")
        bottom_box.config(bg="#B0E0E6")
        search_box.config(bg="#B0E0E6")
        name.config(bg="#B0E0E6")
        clock.config(bg="#B0E0E6")
        date.config(bg="#B0E0E6")
        search_icon.config(bg="#323c3e")
        textfield.config(bg="#323c3e")
        label1.config(bg="#13b3ee")
        label2.config(bg="#13b3ee")
        label3.config(bg="#13b3ee")
        label4.config(bg="#13b3ee")
        w.config(bg="#13b3ee")
        h.config(bg="#13b3ee")
        p.config(bg="#13b3ee")
        d.config(bg="#13b3ee")
        logo.config(bg="#B0E0E6", image=clouds)
        logo.image = clouds
    elif data[0]['weather'][0]['main'] == "Clear":
        bg.config(width=900, height=500, bg="#FFF8DC")
        bottom_box.config(bg="#FFF8DC")
        search_box.config(bg="#FFF8DC")
        name.config(bg="#FFF8DC")
        clock.config(bg="#FFF8DC")
        date.config(bg="#FFF8DC")
        search_icon.config(bg="#43413b")
        textfield.config(bg="#43413b")
        label1.config(bg="#1cb6ec")
        label2.config(bg="#1cb6ec")
        label3.config(bg="#1cb6ec")
        label4.config(bg="#1cb6ec")
        w.config(bg="#1cb6ec")
        h.config(bg="#1cb6ec")
        p.config(bg="#1cb6ec")
        d.config(bg="#1cb6ec")
        logo.config(bg="#FFF8DC", image=clear)
        logo.image = clear
    else:
        bg.config(width=900, height=500, bg="#f0f0f0")
        bottom_box.config(bg="#f0f0f0")
        search_box.config(bg="#f0f0f0")
        name.config(bg="#f0f0f0")
        clock.config(bg="#f0f0f0")
        date.config(bg="#f0f0f0")
        search_icon.config(bg="#404040")
        textfield.config(bg="#404040")
        label1.config(bg="#1ab5ef")
        label2.config(bg="#1ab5ef")
        label3.config(bg="#1ab5ef")
        label4.config(bg="#1ab5ef")
        w.config(bg="#1ab5ef")
        h.config(bg="#1ab5ef")
        p.config(bg="#1ab5ef")
        d.config(bg="#1ab5ef")
        logo.config(bg="#f0f0f0", image=snow)
        logo.image = snow
